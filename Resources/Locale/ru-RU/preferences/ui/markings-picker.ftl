...
markings-category-UndergarmentTop = Нижнее белье (бра)
markings-category-UndergarmentBottom = Нижнее белье (трусы)
markings-category-UndergarmentSocks = Нижнее белье (носки)
