# Errors
loadout-group-species-restriction = Этот товар недоступен для вашей текущей расы.
# Miscellaneous
...
loadout-group-pocket-tank-double = Расозависимый двойной аварийный баллон в кармане
...
loadout-group-salvage-specialist-outerclothing = Утилизатор, верхняя
...
loadout-group-security-star = Звезда безопасности
# Medical
