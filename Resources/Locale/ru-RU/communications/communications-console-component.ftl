...
comms-console-menu-announcement-button-tooltip = Отправьте своё сообщение в качестве радиообъявления на весь сектор.
comms-console-menu-broadcast-button = Трансляция
comms-console-menu-broadcast-button-tooltip = Транслируйте своё сообщение на настенные экраны по всему сектору. Примечание: помещается всего десять символов!
# Frontier: station<sector
comms-console-menu-alert-level-button-tooltip = Изменение уровня угрозы сектора. Применяется сразу после выбора.
