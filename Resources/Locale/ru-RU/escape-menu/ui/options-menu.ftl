...
ui-options-bwoink-sound = Воспроизведение звука уведомлений АХелп
...
ui-options-function-text-cursor-word-left = Перемещение курсора влево на слово
ui-options-function-text-cursor-word-right = Перемещение курсора вправо на слово
...
ui-options-function-text-cursor-select-left = Развернуть выделение влево
ui-options-function-text-cursor-select-right = Развернуть выделение вправо
...
ui-options-function-text-cursor-select-word-left = Разверните выделение слева на слово
ui-options-function-text-cursor-select-word-right = Разверните выделение прямо по слову
ui-options-function-text-cursor-select-begin = Расширить выделение до начала
ui-options-function-text-cursor-select-end = Разверните выделение до конца
ui-options-function-text-backspace = Пробел
ui-options-function-text-delete = Удалить
ui-options-function-text-word-backspace = Слово с пробелом
...
ui-options-function-multiline-text-submit = Отправить многострочный
...
ui-options-function-text-release-focus = Фокусировка
ui-options-function-text-scroll-to-bottom = Прокрутить к низу
ui-options-function-text-tab-complete = Завершение вкладки
ui-options-function-text-complete-next = Завершить следующий
...
ui-options-censor-nudity = Цензура наготы персонажей
ui-options-admin-player-panel = Список игроков в меню администратора
ui-options-admin-playerlist-separate-symbols = Показывать отдельные символы для каждого типа роли антага
ui-options-admin-playerlist-character-color = Цвет имен персонажей антагонистов
ui-options-admin-playerlist-roletype-color = Раскрасить типы ролей
ui-options-admin-overlay-title = Оверлей администратора
ui-options-enable-overlay-symbols = Добавить символ антага в текст
ui-options-enable-overlay-playtime = Показывать время воспроизведения
ui-options-enable-overlay-starting-job = Показать начальное задание
ui-options-overlay-merge-distance = Расстояние слияния стека
ui-options-overlay-ghost-fade-distance = Расстояние затухания призрачного оверлея от мыши
ui-options-overlay-ghost-hide-distance = Расстояние скрытия наложения призрака от мыши
