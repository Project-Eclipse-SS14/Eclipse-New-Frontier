...
handcuff-component-start-cuffing-self-observer = { $user } начинает сдерживать { REFLEXIVE($target) }.
...
handcuff-component-cuff-self-observer-success-message = { $user } сдерживает { REFLEXIVE($target) }.
