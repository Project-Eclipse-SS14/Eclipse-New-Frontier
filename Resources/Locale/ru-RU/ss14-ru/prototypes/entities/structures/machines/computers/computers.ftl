ent-ComputerAlert = консоль атмосферной сигнализации
    .desc = Используется для доступа к автоматизированной системе атмосферной сигнализации станции.
...
ent-WizardComputerComms = консоль связи волшебника
    .desc = Компьютер, способный магическим образом проецировать вашу речь на станцию. Используя его для объявления, вы предупредите станцию о своем присутствии.
