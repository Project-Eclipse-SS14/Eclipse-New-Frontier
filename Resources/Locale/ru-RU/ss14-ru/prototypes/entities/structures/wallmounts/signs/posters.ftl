...
ent-PosterLegitSafetyMothSSD = Моль безопасности - Космическое расстройство сна
    .desc = Этот информационный плакат используют Safety Moth™, чтобы рассказать зрителю о Космическом Расстройстве Сна (КРС), состоянии, при котором человек перестает реагировать на вещи. «Обращайтесь с экипажем РКС осторожно! Они могут проснуться в любой момент!»
