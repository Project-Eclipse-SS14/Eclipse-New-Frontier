...
ent-PlushieLizardInversed = плюшевый хтану
    .desc = Очаровательная мягкая игрушка, напоминающая унатха из инверсированного измерения. Хью!
...
ent-PonderingOrbWizard = размышляющий шар
    .desc = Задумайся, чувак... Действительно задумайся. Волшебным образом показывает сеть камер станции.
    .suffix = Вошебник
...
# HASH: 618603ac764b4a6f2a8e7f3c5e2bd169cac351830d3f3f0e67799abde65a4b52
ent-PlushieExperiment = экспериментальная плюшевая игрушка
    .desc = Плюшевая игрушка в виде канида жаждет, чтобы ее подорвали на мине.
