...
nf-test-description = Предварительный набор, предназначенный для тестирования. Нет точек интереса, нет событий bluespace, конечный пункт назначения.
...
shuttle-ftl-invalid = Неверный шаттл для блюспейс перемещения!
