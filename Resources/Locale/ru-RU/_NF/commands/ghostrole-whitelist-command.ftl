...
cmd-ghostrolewhitelistadd-desc = Позволяет игроку играть в определённую роль призрака из белого списка.
...
cmd-ghostrolewhitelistget-whitelisted-for = "Игрок { $player } имеет доступ к следующим ролям:
{ $ghostRoles }"
