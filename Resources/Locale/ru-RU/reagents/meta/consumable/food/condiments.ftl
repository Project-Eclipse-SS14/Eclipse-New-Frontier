...
reagent-name-coldsauce = соус "Ледяной горизонт"
reagent-desc-coldsauce = соус "Ледяной горизонт". При употреблении язык немеет.
reagent-name-frostoil = ледяной соус
