...
namespace Content.Shared._Eclipse.Audio;
...
[Virtual]
[DataDefinition]
internal partial class CustomDummyAudioSource : IAudioSource
{
    public static CustomDummyAudioSource Instance { get; } = new();
