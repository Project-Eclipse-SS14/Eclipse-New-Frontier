...
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState(true, fieldDeltas: true), Access(typeof(SharedBoomBoxSystem))]
public sealed partial class BoomBoxAudioComponent : Component, IAudioSource
{
    ...
    public IAudioSource Source = new CustomDummyAudioSource();
