...
namespace Content.Shared._Eclipse.SelfShipyard.Components;

[RegisterComponent, NetworkedComponent, Access(typeof(SharedSelfShipyardSystem))]
public sealed partial class SelfShipyardConsoleComponent : Component
{
    public static string TargetIdCardSlotId = "SelfShipyardConsole-targetId";
